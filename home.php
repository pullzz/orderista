                    ...
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="myNavbar">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                          ...
                          <li> <a href="/Orderista/userprofile.php"><span class="glyphicon glyphicon-user"></span><?php echo($_SESSION['username']); ?></a> </li>
                        </ul>
                      </div>
                    </div>
                  </nav>
...
<div data-role="main" class="ui-content">
  ...
  <div class="covercontainer">
    <img class="coverpic" src="/Orderista/images/pizza5.jpeg">
