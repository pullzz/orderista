                    ...
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav">
                          ...
                          <li><a href="#">See Your Pizza</a></li>
                          <li><a href="#">See on Map</a></li>
                        </ul>
...
<?php
      ...
      if(isset($_POST['send'])){
        ...
        $email = "bruteforceteam4@gmail.com";
        $name= $_POST['name'];
        $senderEmail= $_POST['senderemail'];
        $comment= $_POST['comments'];

        $message= "Name:".$name. "\n"."Sender Email:".$senderEmail."\n"."User Inquiry Is:".$comment;
      ...
      <div class="row">
        ...
        <div class="col-sm-7 slideanim">
          <div class="row">
            ...
            <div class="col-sm-6 form-group">
              <input class="form-control" id="email" name="senderemail" placeholder="Email" type="email" required>
            </div>
          </div>
...
<img class="logo" src="/Orderista/images/LOGO.png" >
  ...
  <div class="margin" align="center"> © 2019 Copyright: 
    <a href="/Orderista/home.php">Orderista.com</a>
  </div>
