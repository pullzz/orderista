...
<?php
    ...
    $sql="INSERT INTO favourites(username,product_id,product_name,image_name,description,setFav) VALUES('$username','$product_id','$product_name','$image_name','$description','$setFav')";
